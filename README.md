...
- Manual: skills loaded on demand (126 total; workload-tagged for selective inclusion)

### Skills

126 skill packages under `skills/`, tagged by workload. Installation selects only skills matching active workloads.
...
├── skills/                     # 126 skill packages (workload-tagged)
