...
- Manual: skills loaded on demand (125 total; workload-tagged for selective inclusion)

### Skills

125 skill packages under `skills/`, tagged by workload. Installation selects only skills matching active workloads.
...
├── skills/                     # 125 skill packages (workload-tagged)
