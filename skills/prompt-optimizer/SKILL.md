...
| Infrastructure | /plan, /verify | docker-patterns, deployment-patterns, terraform-deployment | architect |
...
| MongoDB / DynamoDB | mongodb-guideline, mongodb-patterns, dynamodb-guideline | database-reviewer |
