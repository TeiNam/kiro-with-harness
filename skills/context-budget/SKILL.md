---
name: context-budget
description: Audits context window consumption across agents, skills, MCP servers, and rules. Identifies bloat, redundant components, and produces prioritized token-savings recommendations.
origin: harness
---

# Context Budget

Analyze token overhead across every loaded component in a coding session and surface actionable optimizations to reclaim context space.
...
- Running a context budget audit
