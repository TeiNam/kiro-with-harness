...
description: Local-evidence production readiness audit for shipped apps, pre-launch reviews, and post-merge checks without sending repo data to external services.
origin: harness
workloads: [cloud]
---
...
Use this skill when the user asks whether an application is ready to ship, what could break in production, or what must be fixed before a launch. This keeps the production-readiness lens while avoiding external execution and third-party data sharing.
...
- CI is green but the user wants production risk assessment, not only test status.
...
- For a formal compliance audit. This skill is engineering triage, not legal, financial, medical, or regulatory certification.
...
- security-review — line-level secure coding patterns
- deployment-patterns — infrastructure and rollout strategies
- e2e-testing — critical path coverage
- verification-loop — automated testing and validation
- tdd-workflow — test-driven development for reliability
