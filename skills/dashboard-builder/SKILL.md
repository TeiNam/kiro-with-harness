...
description: Build monitoring dashboards that answer real operator questions for Grafana, SigNoz, and similar platforms.
origin: harness
workloads: [frontend, python-data]
---
...
- backend-patterns — API and service design
- production-audit — production readiness assessment
